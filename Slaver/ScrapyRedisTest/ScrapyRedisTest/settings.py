...
# Disable cookies (enabled by default)CONCURRENT_REQUESTS
#COOKIES_ENABLED = False
...
DOWNLOADER_MIDDLEWARES = {
   'ScrapyRedisTest.middlewares.RandomUserAgentDownloaderMiddleware': 543,
...
ITEM_PIPELINES = {
   ...
   # 'ScrapyRedisTest.pipelines.MySQLPipeline': 300,
   'ScrapyRedisTest.pipelines.ElasticsearchPipeline': 300,
...
# ElasticSearch索引名
ELASTICSEARCH_INDEX ="test1" # "test4"
